...
\begin{titlepage}
  ...
  {\Large \textbf{CS5070: Networked Wireless Systems}}\\[1.2cm]

  {\LARGE \textbf{System-Level Network Virtualization
Tutorial Report}}\\[1.4cm]

  \includegraphics[width=0.45\textwidth]{iith.png}\\[1.2cm]

  {\large \textbf{Submitted by}}\\[0.2cm]
  {\large Manish More}\\
  {\large SM25MTECH14001}\\[1.5cm]

  {\large Department of Smart Mobility}\\
  {\LARGE Indian Institute of Technology Hyderabad}\\[0.5cm]
